...
export const QueueMatrix = () => (
  <Card className="border-indigo-900/30">
    <SectionHeader title="21. CUSTOMER_SUPPORT_QUEUE" icon={Users} colorClass="text-indigo-400" />
    <div className="space-y-2">
      ...
      {[
        ...
        <div key={i} className="flex justify-between items-center py-1.5 border-b border-white/[0.04] last:border-0 font-mono text-white">
      ...
      <div className="mt-2 text-center">
         <button className="text-[7px] text-indigo-500 uppercase font-semibold tracking-[0.2em] hover:text-indigo-400 transition-colors">
