...
export const MissionCriticalControls = () => {
  ...
  return (
    <Card className="border-white/[0.04] bg-slate-900/40">
      <SectionHeader title="18. MISSION_CRITICAL_CONTROLS" icon={Zap} colorClass="text-blue-400" />
        ...
        {Object.entries(states).map(([key, val]) => (
          <button 
            ...
            className={cn(
              ...
              val ? "bg-blue-600/10 border-blue-500/30" : "bg-slate-900 border-white/[0.04] opacity-50"
            )}
          >
            ...
            <div className={cn(
              ...
              <div className={cn(
                "absolute top-0.5 w-2 h-2 rounded-full bg-slate-950 transition-all",
